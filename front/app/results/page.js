...
const SECTION_SLUG = 'results'
const COLOR = { bg: 'bg-green-600', light: 'bg-green-50', text: 'text-green-700', border: 'border-green-200', icon: '📊' }
...
export async function generateMetadata({ searchParams }) {
  ...
  return {
    title: `Sarkari Results 2026 — Latest Government Exam Results — Sarkari Afsar`,
    description: 'Check latest Sarkari Results 2026. Government exam results, merit lists, cut-off marks for all central and state recruitment boards at Sarkari Afsar.',
    alternates: { canonical },
    openGraph: {
      title: 'Sarkari Results 2026 — Sarkari Afsar',
      description: 'Check latest Sarkari Results 2026. Government exam results, merit lists and cut-off marks.',
      url: canonical,
      siteName: 'Sarkari Afsar',
      images: [{ url: `${SITE_URL}/api/og?title=Sarkari+Results+2026&type=results`, width: 1200, height: 630, alt: 'Sarkari Results 2026 — Sarkari Afsar' }],
      locale: 'en_IN',
      type: 'website',
    },
    twitter: { card: 'summary_large_image', title: 'Sarkari Results 2026 — Sarkari Afsar', description: 'Check latest Sarkari Results 2026. Government exam results, merit lists and cut-off marks.', site: '@sarkariafsar' },
  ...
  return (
    <tr className="hover:bg-gray-50 transition-colors">
      <td className="px-4 py-2.5">
        <Link href={`/jobs/${job.slug}`} className="text-green-700 hover:underline font-medium leading-snug line-clamp-2">
          {job.title}
        </Link>
      </td>
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-[#1e3a5f] text-white py-14 px-4">
        <div className="container mx-auto max-w-5xl">
          ...
          <h1 className="text-3xl font-bold">Sarkari Results 2026</h1>
          <p className="text-blue-200 mt-2">Latest government exam results, merit lists and cut-off marks</p>
        </div>
      </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-50">
                {jobs.length === 0
                  ? <tr><td colSpan={3} className="py-20 text-center text-gray-400">No results found</td></tr>
