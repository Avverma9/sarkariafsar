...
const SECTION_NAME = 'Latest Gov Jobs'
const SECTION_SLUG = 'latest-jobs'
const COLOR = { bg: 'bg-blue-600', light: 'bg-blue-50', text: 'text-blue-700', border: 'border-blue-200', icon: '💼' }
...
export default async function LatestJobsPage({ searchParams }) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Latest Gov Jobs', item: `${SITE_URL}/latest-jobs` },
    ],
  }
      ...
      <div className="bg-[#1e3a5f] text-white py-14 px-4">
        <div className="container mx-auto max-w-5xl">
          <nav className="text-sm text-blue-300 mb-3" aria-label="breadcrumb">
            ...
            <span className="text-white">Latest Gov Jobs</span>
          </nav>
          <h1 className="text-3xl font-bold">Latest Sarkari Naukri 2026</h1>
          <p className="text-blue-200 mt-2">Latest government job notifications — apply online before last date</p>
        </div>
      </div>
